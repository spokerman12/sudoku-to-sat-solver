...
Previously, our solver could not handle a decent chunk of the problems. It required a more detailed analysis on its code and structures.

Now Our Solver solves all test instances. Check out the section New Version Improvements.
